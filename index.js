...
// function shakeWinner(i) {
//   const leadContainer = document.querySelector(`.a${i}`)
//   leadContainer.querySelector('img').style.top = config.offsetShake
//   const id = setTimeout(() => {

//     if (!!config.winnerShake) {
//       console.log('hahah')
//       leadContainer.querySelector('img').style.top = config.offsetShake
//       config.winnerShake = false
//       config.offsetShake = '-10px'
//     } else {
//       leadContainer.querySelector('img').style.top = config.offsetShake
//       config.winnerShake = true
//       config.offsetShake = '10px'
//     }
//     shakeWinner(i)
// },1000)
...
// document.querySelector('#restart').addEventListener('click', ()=>{
//   clearTimeout(id) // why it is not working
//   leadContainer.querySelector('img').style.top = '0px'
//   restart()
